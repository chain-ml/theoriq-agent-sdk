...
class EthTypedDataMessageType(TypedDict):
    domain: DomainType
...
class Web3EthSignTypedDataBlock(Web3EthBaseBlock):
    ...
    def __init__(
        self, data: EthTypedDataMessageType, key: Optional[str] = None, reference: Optional[str] = None
    ) -> None:
        """
        Initializes a Web3EthSignTypedDataBlock instance.

        Args:
            data (EthTypedDataMessageType): The data to be signed.
        """
    ...
    def from_dict(cls, data: Dict[str, Any], block_type: str) -> Web3EthSignTypedDataBlock:
        ...
        Args:
            data (EthTypedDataMessageType): The dictionary containing the EthTypedDataMessageType data.

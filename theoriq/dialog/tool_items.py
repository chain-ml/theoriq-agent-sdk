...
class ToolCallBlock(BlockBase[ToolCallData, Literal["internal:toolCall"]]):
    @classmethod
    def from_data(cls, *, name: str, arguments: str, id: str) -> ToolCallBlock:
        return ToolCallBlock(block_type="internal:toolCall", data=ToolCallData(name=name, arguments=arguments, id=id))
...
class ToolCallResultBlock(BlockBase[ToolCallResultData, Literal["internal:toolCallResult"]]):
    @classmethod
    def from_data(cls, *, content: str, id: str) -> ToolCallResultBlock:
        return ToolCallResultBlock(
            block_type="internal:toolCallResult", data=ToolCallResultData(content=content, id=id)
        )

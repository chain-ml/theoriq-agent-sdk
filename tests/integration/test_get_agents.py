...
from theoriq.api.v1alpha2.protocol.biscuit_provider import BiscuitProviderFactory, BiscuitProviderFromAPIKey
...
def test_get_agents_with_manager() -> None:
    manager = AgentManager(biscuit_provider=BiscuitProviderFactory.from_api_key(api_key=THEORIQ_API_KEY))
